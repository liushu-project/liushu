                ...
                row.forEach { data ->
                    when (data) {
                        ...
                        is LayoutDefinition.KeyboardItemDef.KeyDef -> {
                            ...
                            val capsLockState = viewModel.capsLockState.collectAsState()
                            ...
                            Key(
                                ...
                                showAsciiText = isAsciiMode.value,
                                showCapsLockText = capsLockState.value == CapsLockState.ACTIVATED || capsLockState.value == CapsLockState.SINGLE_LETTER,
                                onClick = onClick,
